...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 006 | 2023 | AutoGen: Enabling Next-Gen LLM Applications via Multi-Agent Conversation | Framework | Scaling LLM power for complex, real-world tasks that require modular coordination of diverse agents, tools, and human inputs. | A generalized framework based on customizable, conversable agents and a "conversation programming" paradigm to unify intricate workflows. | Yes – Agents maintain internal context based on conversation history and message passing to track task progress and state. | Yes – Supports task decomposition, hierarchical control, and dynamic conversation patterns to break complex goals into manageable subtasks. | Yes – Elicited through implicit state inference, feedback loops, and integration of specialized prompting techniques like ReAct. | Python code execution, function calling, and vector databases. | Yes | Yes | No | Demonstrated superior success rates over single-agent baselines across six applications including math, coding, and decision-making benchmarks. | Safety risks in high-autonomy scenarios and the need for optimal agent topologies to reduce "unintelligible chatter" while maintaining efficiency. | 9 | Provides the essential architectural foundation for orchestrating specialized clinical agents into a unified, conversation-driven framework for patient monitoring and support. |