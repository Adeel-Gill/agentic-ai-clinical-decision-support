...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 001 | 2023 | The Rise and Potential of Large Language Model Based Agents: A Survey | Survey | Lack of a general foundational model to serve as a starting point for adaptive AI agents capable of diverse real-world tasks. | A general framework for LLM-based agents comprising three core components: the brain, perception, and action. | Yes – Hybrid memory using short-term context windows and long-term storage via vector or SQL databases. | Yes – Task decomposition into sub-goals and iterative plan reflection via internal or environmental feedback. | Yes – Elicited through Chain-of-Thought (CoT) prompting, self-consistency, and problem refinement. | APIs, search, code execution (Python), and SQL databases. | Yes | Yes | Yes | Assessed via metrics for utility (task success), sociability, human alignment, and continuous evolution. | Bridging the gap between constrained virtual simulations and boundless physical environments while managing context limits. | 10 | Establishes the core "Brain-Perception-Action" architectural blueprint needed to transition from stateless LLMs to stateful agents for patient monitoring. |