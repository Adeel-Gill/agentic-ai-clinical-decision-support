...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 007 | 2023 | CAMEL: Communicative Agents for “Mind” Exploration of Large Language Model Society | Multi-Agent | LLM success depends on expert-level human prompting, creating a need for autonomous cooperation between agents with minimal human supervision. | A role-playing framework using inception prompting to enable autonomous task-solving through cooperative interactions between specialized AI agents. | Yes – Maintains context via conversational history message sets that record instructions and solutions throughout the session. | Yes – Employs an AI user agent as a task planner to interactively determine and decompose feasible steps for execution. | Yes – Elicited through multi-turn, role-specific instruction-following where agents apply expertise to fulfill common tasks. | Browsing, code execution, and HuggingFace tool agents. | Yes | No | Yes | Evaluated using human participants and GPT-4 to compare summarized multi-agent solutions against single-shot LLM solutions across diverse datasets. | Addressing safety risks from unaligned agents and the need for large-scale evaluation involving numerous domain experts. | 9 | Provides a robust role-playing architecture and inception-prompting strategy to automate specialized collaborative workflows between monitoring agents and clinical decision support roles. |