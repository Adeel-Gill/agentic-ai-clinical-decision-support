...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| P010 | 2023 | MedAgents: Large Language Models as Collaborators for Zero-shot Medical Reasoning | Multi-Agent | LLMs struggle with specialized medical knowledge and complex reasoning, often producing hallucinations when prompted with simple techniques in data-limited clinical domains. | MEDAGENTS, a training-free multi-disciplinary collaboration framework where LLM-based agents role-play as diverse experts to reach consensus via multi-round discussions. | Yes – Maintains working context through iterative report revisions and multi-round expert dialogue until a consensus is reached. | Yes – A five-stage pipeline including expert gathering, analysis proposition, report summarization, collaborative consultation, and final decision-making. | Yes – Zero-shot reasoning enhanced by cross-disciplinary collaborative interaction to elicit intrinsic expertise without fine-tuning. | No | Yes | No | Yes | Evaluated zero-shot performance across nine datasets including MedQA and PubMedQA, outperforming standard CoT and self-consistency baselines. | Parameterized knowledge requires continuous updating to stay current and the framework faces limited applicability in low-resource languages. | 9 | Provides a robust multi-agent orchestration model for simulating multidisciplinary clinical consultations to enhance the accuracy of automated medical decision support. |