...
Trustworthiness in this framework is a set of mechanisms, not a checklist, and each mechanism is wired into the layer where its concern originates [rasheed2022explainable].
