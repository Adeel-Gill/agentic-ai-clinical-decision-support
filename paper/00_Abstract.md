...
tools, sustain diagnostic dialogue, and in one documented case run prospectively at the
bedside, we identify three properties needed for trust in a specific patient that no
published system measures: retrieval grounded in the patient's own longitudinal record
