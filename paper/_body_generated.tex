...
This subsection describes the designed orchestration; as Table~\ref{tab:1} records, the seven agents
exist as an implementation scaffold, no LLM-based reasoning ran in the pilot of Section~V,
...
verification), each of which uses ReAct-style reasoning internally \cite{yao2023react}. Coordination follows a hub-and-spoke
...
\cite{es2024ragas}. The confidence value attached to each recommendation is calibrated post hoc on
...
reliability diagrams \cite{guo2017calibration}. This combination is designed to align with
...
generalization to other care settings \cite{johnson2023mimic}. Fourth, verification quality is
...
onset and intervention concordance (Section~III-F). Leakage was controlled at three points: features were computed
